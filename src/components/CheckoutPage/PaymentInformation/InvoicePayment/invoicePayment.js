...
import defaultClasses from './invoice.module.css';
import { FormattedMessage } from 'react-intl';

/**
 * The Invoice component renders all information to handle invoice payment.
 *
    ...
    return (
        <div className={classes.root}>
            ...
            <p className={classes.mailingAddressTitle}>
                <FormattedMessage
                    id={'invoice.mailingAddressTitle'}
            ...
            <p className={classes.note}>
                <FormattedMessage
                    id={'invoice.note'}
                    defaultMessage={
                        'Note: Your order will be shipped once the Invoice Order has been received and processed.'
                    }
                />
            </p>
            <BillingAddress
